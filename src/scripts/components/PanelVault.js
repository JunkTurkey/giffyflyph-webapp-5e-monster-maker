...
class PanelVault extends Component {
	...
	renderComponent() {
		...
		this.table = $("#table-monsters").DataTable({
			...
			stateSave: true,
			language: {
				sInfo: "Показано от _START_ до _END_ из _TOTAL_ существ всего",
				sInfoEmpty: "Показано от 0 до 0 из 0 существ всего",
				sInfoFiltered: "(отфильтровано из _MAX_ существ всего)",
				sLengthMenu: "_MENU_",
