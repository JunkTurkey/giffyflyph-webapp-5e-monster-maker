...
константа DEFAULT_TRAITS = [
	...
	},
	{
		...
		description: "Ваша защита непробиваема. Получите +2 AC".
	},
	{
		id:6,
		role: "defender",
	...
	},
	{
		...
		role: null,
		name: "Полет",
		description: "Вы можете летать со своей скоростью. Во время полета вы должны двигаться со всей скоростью своего движения или приземлиться — если вы также не можете парить. Запуск в полет провоцирует атаки, даже если вы совершаете <i> Отход </i> " .
	},
	{
		id:64,
		role: null,
